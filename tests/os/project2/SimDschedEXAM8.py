...
top=899					#max disk track number - This can be changed to uniquely identify a particular simulator in the output

group=""
while (not group.isalnum()):
    group=removePunc(my_input("Please enter your class group (e.g. SDH2B): "))
snum=""
