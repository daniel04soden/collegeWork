...
public class Student {
  ...
  public void printStudentInfo(int option) {
     ...
     * And at 3 it will check if the student is part of that society and from there
     * it will push you to join if not
     */
    if (option == 1) {
  ...
  public int sumOfIDDigits() {
     ...
     * a String of characters and from here it turns those characters into numbers
     * and adds them together
     * String and character methods learned from java documentation myself
     * previously
     */
    ...
    for (int i = 0; i < seperatedId.length(); i++) {
      ...
      sum += Character.getNumericValue(individualId); // Add each individual numeric character until length of string
                                                      // hit
    }
    return sum;
  }
