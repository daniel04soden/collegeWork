...
public class Computer extends Product {
   ...
   * Although my other classes insert it into sql, we will not be explicitly
  ...
  // ---------------------------------------
  /**
   * Given a concrete computer, this method sets the amount of storage in the
   * computer.h<br>
   * 
  ...
  // ---------------------------------------
  /**
   * Given a concrete computer, this method sets the amount of ram in the
   * computer.<br>
   * 
  ...
  // ---------------------------------------
  /**
   * j * Given a concrete computer, this method sets the name of the cpu ie new
   * CPU.<br>
   * 
  ...
  // ---------------------------------------
  /**
   * Given a concrete computer, this method sets the name of the gpu ie new
   * GPU.<br>
   * 
