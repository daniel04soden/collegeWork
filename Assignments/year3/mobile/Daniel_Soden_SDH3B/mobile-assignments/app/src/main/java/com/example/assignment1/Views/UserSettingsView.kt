...
fun UserSettingsScreen(
    ...
    fun clearData(){
        ...
        viewModel.onCaloriesPerDayChange("")
                ...
                onClick = {
                    viewModel.currentUser.value?.let { currentUser ->
                        val updatedUser = currentUser.copy(
                            ...
                            caloriesPerDay = caloriesPerDay.toDoubleOrNull() ?: currentUser.caloriesPerDay
                        )
