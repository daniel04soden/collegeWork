...
public class PurchaseView {
    private final PurchaseController prc;
    ...
    public VBox mainPurchase(Stage stage) {
        ...
        history.setOnAction(openHistory->{
        ...
        addProduct.setOnAction(addToSys->{
        ...
        sortByPrice.setOnAction(sort-> prc.execSort(area,false));



        checkout.setText("Checkout");
        checkout.setOnAction(checkoutOn->{
    ...
    public HBox checkStock(Stage stage,ComboBox<Product> productBox){
        ...
        checkStock.setOnAction(stockCheck->{
