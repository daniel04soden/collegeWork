...
public class CustomerView {
    ...
    public VBox customerHome(Stage stage) {
        ...
        register.setOnAction(openRegPage -> stage.getScene().setRoot(registerPage(stage)));

        // View Customers button
        Button view = new Button();
        view.setText("View other customers");
        view.setOnAction(openViewCustomers -> stage.getScene().setRoot(viewCustomers(stage)));

        // Remove Customers button
        Button remove = new Button();
        remove.setText("Remove Customers");
        remove.setOnAction(openRemoveCustomers -> stage.getScene().setRoot(removePage(stage)));
        // Increase balance button

        Button balanceIncr = new Button();
        balanceIncr.setText("Increase customer balance");
        balanceIncr.setOnAction(openBalanceIncrPage-> stage.getScene().setRoot(addToBalance(stage)));

        // Load data button
        Button load = new Button();
        load.setText("Load Customer Data");
        load.setOnAction(openLoadCustPage -> stage.getScene().setRoot(loadData(stage)));

        // Save data button
        Button save = new Button();
        save.setText("Save Customer Data");
        save.setOnAction(saveCustomerData -> controller.save());
