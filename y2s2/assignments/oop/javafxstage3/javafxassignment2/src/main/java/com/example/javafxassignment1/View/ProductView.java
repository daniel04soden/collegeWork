...
public class ProductView {
    ...
    public VBox productHome(Stage stage) {
        ...
        save.setOnAction(openSave -> controller.save());
        ...
        register.setOnAction(registerTransition -> stage.getScene().setRoot(productRegisterPage(stage)));
        view.setOnAction(viewTransition -> stage.getScene().setRoot(viewProducts(stage)));
        remove.setOnAction(removeTransition -> stage.getScene().setRoot(removeProduct(stage)));
        load.setOnAction(loadTransition -> stage.getScene().setRoot(loadProducts(stage)));
