*Primitive Obsession* refers to an anti-pattern where developers heavily rely on primitive data types instead of encapsulating related data into well-defined domain objects
