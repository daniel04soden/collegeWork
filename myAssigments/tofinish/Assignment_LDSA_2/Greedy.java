...
public class Greedy {
  ...
  public static LinkedList<Integer> makeChange(int amount, int[] denominations) {
    ...
    for (int i = 0; i < n; i++) { // Loop over the types of change we have
      if (denominations[i] <= amount) { // If the change at the array is less than or equal to the amount add to list
                                        // and go back one
  ...
  public static void main(String[] args) {
    ...
    makeChange(1234, new int[] { 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1 })
        .forEach(i -> System.out.println(i));
    System.out.println("Test two");
    makeChange(34567, new int[] { 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1 })
        .forEach(i -> System.out.println(i));
    System.out.println("Test three");
    makeChange(900, new int[] { 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1 })
        .forEach(i -> System.out.println(i));
    System.out.println("Test four");
    makeChange(25, new int[] { 5000, 2000, 1000, 500, 200, 100, 50, 20, 10, 5, 2, 1 })
        .forEach(i -> System.out.println(i));
