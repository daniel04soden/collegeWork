    ...
    while (!finish) {
      ...
      switch (option) {
        ...
        case 2 -> {
          ...
          if (myInt == -1)
            System.out.println(
                "Sorry, no user is registered with id = " + myInt + " so the remove operation cannot proceed.");
          else if (myInt == -2)
            System.out.println(
                "Sorry, the user with id = " + myInt + " has pending borrows, so the remove operation cannot proceed.");
          else
        ...
        case 7 -> {
          ...
          if (!myBool) {
            System.out.println(
                "Sorry, no item is registered with id = " + myInt + " so the remove operation can not proceed.");
          } else
