## Pure JS character encoding conversion [\[\[<https://travis-ci.org/ashtuchkin/iconv-lite.svg?branch=master>](https://travis-ci.org/ashtuchkin/iconv-lite)\]\] {#pure-js-character-encoding-conversion-build-status}
