...
1. 2 mins 2 seconds
2. 7 clicks
3. Buried between various pages, had to search in the end iv As a surfer
   in Donegal, I want to find out differences between weather warnings
   so that I can ensure my safety.

Task Two

1. The student would need to find out the programme code or CRN. On this
   website they would also need to find out their own timetable and
   whether or not this module fits into their timetable.
