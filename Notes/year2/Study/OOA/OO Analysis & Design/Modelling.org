...
*Conceptual* - Do not consider any aspects of implementation - Focus on
identifying objects *Specification* - Consider interfaces of objects -
Focus on how objects interact *Implementation* - Consider all details of
objects - Focus on how to code objects ### Principles *Principle 1 -
Choice of Model is Important* - Models you create influence how a
problem is attacked and solution is shaped *Principle 2 - Levels of
Precision May Differ* - Every model can be expressed with different
levels of precision *Principle 3 - The Models are Connected to
Reality* - All models simplify reality - A good model reflects
