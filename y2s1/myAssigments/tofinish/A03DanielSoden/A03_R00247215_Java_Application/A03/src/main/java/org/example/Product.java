...
/**
 * This class models a product int the Shop<br>.
 */
public abstract class Product extends Agent{ // This class models a Product in a shop with various attributes
    ...
    protected int currentStock; // Amount of stock around
    protected int amountOnOrder; // Amount of stock getting in
    ...
    /**
     * this using a concrete product returns its price
    ...
    //---------------------------------------
    /**
     * This method, given a concrete product, sets a new price
    ...
    //---------------------------------------
    /**
     * This method given a concrete product, adjusts the current amount on order
